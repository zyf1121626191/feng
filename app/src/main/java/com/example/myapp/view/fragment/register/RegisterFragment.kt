package com.example.myapp.view.fragment.register
...
import com.example.myapp.view.fragment.login.LoginFragment
...
class RegisterFragment : AbstractFragment() {
    ...
    private fun checkValid(): Boolean {
        ...
        var b1 = userName.length in 1..10
        var checkNickName = XRegexUtils.checkUserName(userName)
        var checkPassword = XRegexUtils.checkPassword(password)
        var b3 = password == passwordAgain
        var b4 = password.length in 1..18
        var b = b1 && checkNickName &&
                b3 && b4 &&
                checkPassword
        return b
    }
